...
public class C03_ActionMoveToElement extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        Actions actions = new Actions(driver);//mause ile yapilan islemlerde action objesi olusturulur.

        WebElement dilMenu = driver.findElement(By.xpath("//div[text()='EN']"));

        actions.moveToElement(dilMenu).perform(); //Not:movetoElement:Mause ile ustune geldiginde acilan webelmentlere denir.
                                                  //Burada movetoelment ile mause 'u menunun uzerine getirdik.
        Thread.sleep(2000);
        ...
        WebElement ddm = driver.findElement(By.xpath("//select[@id='icp-dropdown']"));//Dropdown menu locate'i alirken select tagindan almaliyiz.

        Select select = new Select(ddm); //Dropdown menuden secim yapmak icin select objesi olusturmamiz lazim.

        select.selectByVisibleText("Turkey (Türkiye)");//ve opsiyonlardan bir tanesini sectik.text,indexvs.
